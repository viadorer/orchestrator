...
const TASK_TYPES = [
  ...
  { value: 'auto_enrich_kb', label: 'Obohatit KB', icon: BookOpen, desc: 'AI navrhne nové KB záznamy z gap analýzy' },
  { value: 'cross_project_dedup', label: 'Cross-project dedup', icon: Shield, desc: 'Zkontroluje duplicity napříč projekty' },
  { value: 'generate_ab_variants', label: 'A/B varianty', icon: Sparkles, desc: 'Vygeneruje alternativní verze postu' },
